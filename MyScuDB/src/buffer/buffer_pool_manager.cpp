...
// find an unused page
// first find from free_list_
// then find from replacer
// return nullptr if none
Page *BufferPoolManager::getUnusedPage()
{
    Page *page = nullptr;

...
test/CMakeFiles/lock_manager_test.dir/concurrency/lock_manager_test.cpp.o: ../test/concurrency/lock_manager_test.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/mnt/d/the_remote_city/Database/scudb_initial/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object test/CMakeFiles/lock_manager_test.dir/concurrency/lock_manager_test.cpp.o"
	cd /mnt/d/the_remote_city/Database/scudb_initial/build/test && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/lock_manager_test.dir/concurrency/lock_manager_test.cpp.o -c /mnt/d/the_remote_city/Database/scudb_initial/test/concurrency/lock_manager_test.cpp
...
test/CMakeFiles/lock_manager_test.dir/concurrency/lock_manager_test.cpp.i: cmake_force
	...
	cd /mnt/d/the_remote_city/Database/scudb_initial/build/test && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /mnt/d/the_remote_city/Database/scudb_initial/test/concurrency/lock_manager_test.cpp > CMakeFiles/lock_manager_test.dir/concurrency/lock_manager_test.cpp.i
...
test/CMakeFiles/lock_manager_test.dir/concurrency/lock_manager_test.cpp.s: cmake_force
	...
	cd /mnt/d/the_remote_city/Database/scudb_initial/build/test && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /mnt/d/the_remote_city/Database/scudb_initial/test/concurrency/lock_manager_test.cpp -o CMakeFiles/lock_manager_test.dir/concurrency/lock_manager_test.cpp.s
...
test/lock_manager_test: test/CMakeFiles/lock_manager_test.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/mnt/d/the_remote_city/Database/scudb_initial/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable lock_manager_test"
	cd /mnt/d/the_remote_city/Database/scudb_initial/build/test && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/lock_manager_test.dir/link.txt --verbose=$(VERBOSE)
...
test/CMakeFiles/lock_manager_test.dir/clean:
	cd /mnt/d/the_remote_city/Database/scudb_initial/build/test && $(CMAKE_COMMAND) -P CMakeFiles/lock_manager_test.dir/cmake_clean.cmake
.PHONY : test/CMakeFiles/lock_manager_test.dir/clean

test/CMakeFiles/lock_manager_test.dir/depend:
	cd /mnt/d/the_remote_city/Database/scudb_initial/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /mnt/d/the_remote_city/Database/scudb_initial /mnt/d/the_remote_city/Database/scudb_initial/test /mnt/d/the_remote_city/Database/scudb_initial/build /mnt/d/the_remote_city/Database/scudb_initial/build/test /mnt/d/the_remote_city/Database/scudb_initial/build/test/CMakeFiles/lock_manager_test.dir/DependInfo.cmake --color=$(COLOR)
